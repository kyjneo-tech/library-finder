    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-2xl mx-auto px-6 py-12">
        ...
        <p className="text-gray-600 mb-10 leading-relaxed">
          도서관은 단순히 책을 빌리는 곳 그 이상입니다. 세금으로 운영되는 수많은 혜택들을 빠짐없이
          누리고 계신가요? 지금 바로 활용할 수 있는 도서관 이용 꿀팁을 공개합니다.
        </p>
        ...
        <div className="space-y-10">
          ...
          <section className="group">
            ...
            <p className="text-gray-600 leading-relaxed pl-13">
              ...
              수만 권의 전자책과 오디오북을 무료로 이용할 수 있습니다. 따로 도서관에 방문할 필요
              없이 스마트폰이나 태블릿으로 바로 읽을 수 있어 편리합니다.
            </p>
          </section>
          ...
          <section className="group">
            ...
            <p className="text-gray-600 leading-relaxed pl-13">
              ...
              코딩 수업 등 수많은 양질의 프로그램이 무료 혹은 저렴한 가격에 제공됩니다. 매월 초
              도서관 홈페이지 공지사항을 확인하는 습관을 가져보세요.
            </p>
          </section>
          ...
          <section className="group">
            ...
            <p className="text-gray-600 leading-relaxed pl-13">
              노트북 좌석, 멀티미디어실(DVD 시청), 스터디룸 대여 등 도서관은 최고의 공유 오피스이자
              휴식처입니다. 최근 리모델링된 도서관들은 카페보다 더 멋진 인테리어를 자랑하며 쾌적한
              환경을 제공합니다.
            </p>
          </section>
        </div>
