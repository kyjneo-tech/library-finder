    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-2xl mx-auto px-6 py-12">
        ...
        <p className="text-gray-600 mb-10 leading-relaxed">
          아이들은 성장에 따라 세상을 보는 눈이 달라집니다. 각 발달 단계에 꼭 맞는 책을 선물해
          주세요. 독서에 대한 흥미가 배가됩니다.
        </p>
        ...
        <div className="space-y-12">
          <section>
            ...
            <div className="bg-gray-50 p-6 rounded-2xl space-y-3">
              <p className="text-gray-600 text-sm leading-relaxed">
                ...
                다양한 질감을 느낄 수 있는 촉감 책이 좋습니다. 의성어와 의태어가 풍부한 짧은 문장의
                책을 골라주세요.
              </p>
          ...
          <section>
            ...
            <div className="bg-gray-50 p-6 rounded-2xl space-y-3">
              <p className="text-gray-600 text-sm leading-relaxed">
                어휘력이 폭발적으로 늘어나는 시기입니다. 기승전결이 있는 이야기 그림책이나 주변
                사물의 이름을 알려주는 인지 책이 좋습니다. 상상력을 자극하는 판타지 동화나 생활
                습관을 바로잡아주는 생활 동화도 추천합니다.
              </p>
              <ul className="text-xs text-gray-400 font-bold list-disc pl-5">
          ...
          <section>
            ...
            <div className="bg-gray-50 p-6 rounded-2xl space-y-3">
              <p className="text-gray-600 text-sm leading-relaxed">
                학교 갈 준비를 하는 시기로 사회성이 발달합니다. 친구 관계, 가족 사랑 등 정서적인
                주제의 책이나 과학, 역사에 대한 호기심을 풀어주는 정보 그림책이 좋습니다. 글밥이
                조금씩 늘어나는 그림책을 시도해 보세요.
              </p>
              <ul className="text-xs text-gray-400 font-bold list-disc pl-5">
                <li>전래 동화, 명작 동화</li>
          ...
          <section>
            ...
            <div className="bg-gray-50 p-6 rounded-2xl space-y-3">
              <p className="text-gray-600 text-sm leading-relaxed">
                스스로 읽는 즐거움을 느껴야 하는 시기입니다. 줄글로 넘어가는 단계이므로 아이의
                관심사에 맞는 만화나 동화책을 자유롭게 읽게 해주세요. 교과 과정과 연계된 인물
                이야기나 사회 분야의 책도 도움이 됩니다.
              </p>
              <ul className="text-xs text-gray-400 font-bold list-disc pl-5">
                <li>초등 필독서, 위인전</li>
                <li>어린이 잡지, 학습 만화</li>
